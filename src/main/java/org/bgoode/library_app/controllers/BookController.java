...
import org.bgoode.library_app.dao.BookDAO;
...
public class BookController {
    ...
    public String show(@PathVariable("id") int id, Model model) {
        ...
        if (bookOwner.isPresent()) {model.addAttribute("book_owner", bookOwner.get());}
   ...
   @DeleteMapping("/{id}")
    ...
    public String assign(@ModelAttribute Person owner, @PathVariable("id") int id) {
        bookDAO.assign(owner.getId(), id);
        return "redirect:/books/" + id;
    }
